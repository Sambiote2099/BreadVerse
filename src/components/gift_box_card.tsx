...
export default function ProductCards({
  ...
  return (
    <main ref={ProductsRef} className="min-h-screen px-4 md:px-8 mt-16 py-10 bg-[#f3ecd8] dark:bg-[#4A4036] transition-colors duration-1000">
      <div >
      <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 text-3xl sm:text-4xl font-bold font-serif justify-center dark:text-[#e5dacc] text-[#482005a4]">
        <AnimatedTextRightCopy text="Gift"/><AnimatedTextLeftCopy text=" Boxes ˚.🎁⋆"/>
      </div>
      ...
      <div className="max-w-2xl mx-auto mb-8 px-4">
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search for Gift Boxes for your loved ones..."
