...
export async function GET(request: Request) {
  try {
    ...
    const totalCount = await db.collection("gift_boxes").countDocuments(query);
    
    // Get paginated results
    const products = await db
      .collection("gift_boxes") // Fixed typo: porducts → products
      .find(query)
...
export async function POST(req: Request) {
  try {
    ...
    const result = await db.collection("gift_boxes").insertOne(product);
